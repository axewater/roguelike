...
# Dragon horn defaults
DEFAULT_DRAGON_NUM_HORNS = 2  # Number of horns (0-4)
DEFAULT_DRAGON_HORN_BRANCH_DEPTH = 1  # Branching levels (0-2)
DEFAULT_DRAGON_HORN_BRANCH_COUNT = 2  # Branches per segment (1-3)
DEFAULT_DRAGON_HORN_BASE_SIZE = 0.15  # Base horn segment size
DEFAULT_DRAGON_HORN_COLOR = (255, 220, 180)  # Bone/ivory color (RGB 0-255)

# Dragon horn limits
MIN_DRAGON_NUM_HORNS = 0
MAX_DRAGON_NUM_HORNS = 4
MIN_DRAGON_HORN_BRANCH_DEPTH = 0
MAX_DRAGON_HORN_BRANCH_DEPTH = 2
MIN_DRAGON_HORN_BRANCH_COUNT = 1
MAX_DRAGON_HORN_BRANCH_COUNT = 3
MIN_DRAGON_HORN_SIZE = 0.05
MAX_DRAGON_HORN_SIZE = 0.4
