...
def create_warrior_model(position=Vec3(0, 0, 0), scale=Vec3(1, 1, 1)):
    ...
    body = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(180, 60, 40),  # Red armor
        scale=(0.5, 0.6, 0.3),
        position=(0, 0, 0)
    )
    ...
    helmet = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(140, 140, 150),  # Steel gray
    ...
    sword = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(200, 200, 210),  # Silver blade
        scale=(0.08, 0.8, 0.08),
        position=(0.5, 0.2, 0),
    ...
    hilt = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(100, 80, 50),  # Brown leather
    ...
    shield = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(60, 120, 180),  # Blue shield
    ...
    shield_boss = Entity(
        parent=warrior,
        model='sphere',
        color=color.rgb(180, 160, 50),  # Gold
        scale=(0.1, 0.1, 0.05),
    ...
    left_leg = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(80, 70, 60),  # Dark brown pants
        scale=(0.2, 0.5, 0.2),
        position=(-0.15, -0.6, 0)
    )
    ...
    belt = Entity(
        parent=warrior,
        model='cube',
        color=color.rgb(60, 50, 40),  # Leather belt
        scale=(0.52, 0.1, 0.32),
        position=(0, -0.3, 0)
    )
